...
<html lang="en">
    <head>    
        ...
        <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/forms/theme-checkbox-radio.css') }}">
       <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/forms/switches.css') }}">
        <link href="{{ asset('plugins/line-awesome/1.3.0/css/line-awesome.css') }}" rel="stylesheet" type="text/css" />
        ...
        <div class="header-container">
            <header class="header navbar navbar-expand-sm">
                ...
                <div class="nav-logo align-self-center">
                    <a class="navbar-brand" href="{{ URL('template')}}"><img alt="logo" src="{{ asset('images/syslogo.png') }}">
                        ...
                        <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown"
                            ...
                            <div class="media">
                                ...
                                <div class="media-body align-self-center">
                                    <h6>@guest Ibson @else {{ Auth::user()->name }} @endguest</h6>
                                </div>
                            </div>
                    ...
                    <ul class="list-unstyled menu-categories" id="topAccordion">
                        <li class="menu single-menu ">
                            ...
                            <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                                <li>
                                    <a href="javascript:void(0)"> ESTADÍSTICOS </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu single-menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="configurations" data-parent="#topAccordion">
                                <li>
                                    <a href="{{ url('/empresas') }}">COMPAGNIES </a>
                                </li>

                                <li>
                                    <a href="{{ url('/cajones') }}"> PARKINGS </a>
                                </li>

                                <li>
                                    <a href="{{ url('/tipos') }}"> TYPES DE VEHICULES </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu single-menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="cashRegisters" data-parent="#topAccordion">
                                <li>
                                    <a href="javascript:void(0)"> HACER CORTE </a>
                                </li>

                                <li>
                                    <a href="{{ url('/cajas') }}"> MOUVEMENTS </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="menu single-menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="reports" data-parent="#topAccordion">
                                ...
                                <li>
                                    <a href="javascript:void(0)"> VENTAS POR FECHAS </a>
                                </li>
                                ...
                                <li>
                                    <a href="javascript:void(0)"> RENTAS PRÓXIMAS</a>
                                </li>
                        ...
                        <li class="menu single-menu">
                            ...
                            <ul class="collapse submenu list-unstyled" id="users" data-parent="#topAccordion">
                                <li>
                                    <a href="{{url('usuarios')}}">OPERATEURS</a>
                                </li>

                                <li>
                                    <a href="{{url('clientes')}}"> CLIENTS </a>
                                </li>
                            </ul>
                        </li>
                    </ul>
        ...
        <!-- VALIDACIONES GLOBALES DEL SISTEMA -->
         ...
         @if($tipo <=0)
           <script type="text/javascript">
               toastr.warning("Veuillez créer un type de véhicules ")
           </script>
        @endif
