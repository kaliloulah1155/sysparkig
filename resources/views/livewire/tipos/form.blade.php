<div class="row layout-top-spacing">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="widget-content-area br-4">
            <div class="widget-one">
              ...
              <h5>
                 <b>  @if($selected_id ==0)    	Créer un nouveau type de véhicule    @else        Modifier le type de véhicule   @endif  </b>
             </h5>
    ...
    <div class="row">                               
                ...
                <input type="text" class="form-control" placeholder="Libellé du type" wire:model.lazy="description">
            </div>
    ...
    <button  type="button" wire:click="doAction(1)" class="btn btn-dark mr-1 mt-4">
        <i class="mbri-left"></i> Annuler
    </button>
    <button type="button"
    wire:click="StoreOrUpdate() " 
    class="btn btn-primary mt-4">
    <i class="mbri-success"></i> Valider
</button>
